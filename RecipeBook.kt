...
class RecipeBook(private var _filename: String = "", private var _recipeList: List<Recipe> = emptyList() ) {
    //I would normally define all properties here, but for this class, all of my properties are already inside the constructor.
